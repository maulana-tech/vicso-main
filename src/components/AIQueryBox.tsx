    ...
    <div className="space-y-3">
      <form onSubmit={handleSubmit} className="relative">
        ...
        <input
          ...
          className="w-full rounded-xl border border-border bg-card py-3 pl-10 pr-12 text-sm text-foreground outline-none focus:border-primary transition-colors"
        />
        <button
          type="submit"
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              {analysis?.verdict && (
                <span className={`rounded-full px-2 py-0.5 text-[10px] font-bold ${
                  analysis.verdict === "BUY" ? "bg-emerald-500/10 text-emerald-500" :
                  analysis.verdict === "HOLD" ? "bg-amber-500/10 text-amber-500" :
            ...
            {analysis?.entryExit && analysis.verdict !== "AVOID" && (
              <div className="mt-3 rounded-lg border border-border bg-secondary/30 p-2.5">
                ...
                <div className="grid grid-cols-2 gap-1.5 text-[10px]">
                  ...
                  <span className="text-muted-foreground">TP: <span className="font-mono text-emerald-500">${analysis.entryExit.takeProfit1.toFixed(4)}</span></span>
